...
ref_pos = [info.obsInfo["aim_ra"],info.obsInfo["aim_dec"]]
info = ChandraObservationInformation(obs11713, npix_s, npix_e, fov, elim, center=(info.obsInfo["aim_ra"], info.obsInfo["aim_dec"]))
