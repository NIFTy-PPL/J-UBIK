...
psf_f = lsp_psf("psf_1e6.npy",3,1)
psf_mf= lsp_psf("psf_1e6_moreflux.npy",3,1)
psf_emf= lsp_psf("psf_1e6_evenmoreflux.npy",3,1)
psf_Mf= lsp_psf("psf_1e6_megaflux.npy",3,1)
psf_gf= lsp_psf("psf_1e6_gigaflux.npy",3,1)

fig, ax = plt.subplots()
ax.plot(psf_f[340:390], label="1e-3 flux")
ax.plot(psf_mf[340:390], label="1e-1 flux")
ax.plot(psf_emf[340:390], label="1e1 flux")
ax.plot(psf_Mf[340:390], label="1e3 flux")
ax.plot(psf_gf[340:390], label="1e6 flux")
ax.legend()
ax.set_yscale('log')
fig.savefig('psf_flux_comp_nn.png', dpi = 500)

#TODO More Flux / check different runs for same configs
#TODO Axis for projection
