...
if __name__ == "__main__":
    ...
    #                                                         abs=nwr_cfg[
    #                                                             'abs'] if 'abs' in nwr_cfg else False,
    #                                                         min_counts=nwr_cfg[
    #                                                             'min_counts'] if 'min_counts' in nwr_cfg else None,
    #                                                         nbins=nwr_cfg[
    #                                                             'n_bins'] if 'n_bins' in nwr_cfg else None,
    #                                                         range=nwr_cfg[
    #                                                             'range'] if 'range' in nwr_cfg else None,
    #                                                         plot_kwargs=nwr_cfg[
    #                                                             'plot_kwargs'] if 'plot_kwargs' in nwr_cfg else None)
    #
    #
    #
