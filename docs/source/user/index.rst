...
However, J-UBIK is more driven by real instruments and their data. It facilitates the implementation of the central components of Bayesian inference, namely likelihood models for different instruments. It currently includes implementations for the X-ray telescopes Chandra and eROSITA, the infrared observatory JWST, and radio interferometers through Resolve. Several demos showcase these likelihood implementations.
