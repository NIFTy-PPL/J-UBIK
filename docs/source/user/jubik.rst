...
Sky coordinates and array orientation
-------------------------------------

Every instrument shares one sky-array convention. Start with the coordinate
reference for shapes, frame/equinox configuration, pointing and plotting;
the design page records the rationale and tested instrument boundaries.
