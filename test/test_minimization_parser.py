...
class TestMinimizationParser:
    ...
    def test_get_range_index_out_of_range_clamps_to_last(self):
        # Iterations beyond n_total_iterations clamp to the last switch
        # range instead of raising (c3eefbe5).
