...
def priors():
    ...
    priors_dict["diffuse"]["spatial"]["fluctuations"]["fluctuations"] = [0.5, 0.2]
    priors_dict["diffuse"]["spatial"]["fluctuations"]["loglogavgslope"] = [-4.0, 0.3]
    priors_dict["diffuse"]["spatial"]["fluctuations"]["flexibility"] = [0.4, 0.1]
    priors_dict["diffuse"]["spatial"]["fluctuations"]["asperity"] = None
    priors_dict["diffuse"]["spatial"]["fluctuations"]["non_parametric_kind"] = "power"
    ...
    priors_dict["diffuse"]["plaw"]["fluctuations"]["fluctuations"] = [0.5, 0.2]
    priors_dict["diffuse"]["plaw"]["fluctuations"]["loglogavgslope"] = [-4.0, 0.3]
    priors_dict["diffuse"]["plaw"]["fluctuations"]["flexibility"] = [0.4, 0.1]
    priors_dict["diffuse"]["plaw"]["fluctuations"]["asperity"] = None
    priors_dict["diffuse"]["plaw"]["fluctuations"]["non_parametric_kind"] = "power"
