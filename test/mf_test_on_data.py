...
config_path = os.path.join(path_to_mock_rec, 'config_512_Mock_run.yaml')
...
log_likelihood = jft.Poissonian(data_arr).amend(response_func).amend(sky_dict['sky'])
...
kl_solver_kwargs['minimize_kwargs']['absdelta'] *= cfg['grid'][
    'npix']  # FIXME: Replace by domain information
