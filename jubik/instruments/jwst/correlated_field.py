...
from .parse.correlated_field import (
    CfmFluctuationsConfig,
    MaternFluctuationsConfig,
)
...
def build_single_correlated_field_from_config(
    ...
    config: CfmFluctuationsConfig | MaternFluctuationsConfig,
) -> jft.Model:
    cfm = jft.CorrelatedFieldMaker(f"{prefix} ")
    ...
    if isinstance(config, CfmFluctuationsConfig):
    ...
    elif isinstance(config, MaternFluctuationsConfig):
        ...
        raise NotImplementedError(
            ...
            "`MaternFluctuationsConfig` or `CfmFluctuationsConfig`."
        )
