...
class Grid:
    ...
    def index_grid(
        self, extend_factor=1, to_bottom_left=True
    ...
    def rel_coords(
        self, extend_factor=1, unit=units.arcsec, to_bottom_left=True
    ) -> ArrayLike:
        """
        ...
        ArrayLike
            ...
            specified unit.
        """
        wl_coords = self.wl_coords(extend_factor, to_bottom_left=to_bottom_left)
