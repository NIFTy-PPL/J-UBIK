...
class ChandraObservationInformation():
    ...
    def __init__ (self, obsInfo, npix_s, npix_e, fov, elim, center=None, obs_type=None):
        ...
        * aspect_sol = the pointing to the telescope, found in the primary data products and ending in _asol1.fits
        ...
        fov (float)    : spatial extent from xmin to xmax, to be considered (in arcmin).
        ...
        # FIXME really?
        self.obsInfo['xy_range'] = 60.*fov/2/0.492 # conv from arcmin to arcsec * full fov / 2 (for half fov) / 0.492 (pixel size)
        ...
        self.obsInfo['spix']     = fov  # spatial pixel scale in arcmin
